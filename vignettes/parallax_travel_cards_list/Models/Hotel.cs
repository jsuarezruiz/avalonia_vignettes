...
/// <summary>
/// A hotel recommendation shown under the travel cards. Port of <c>demo_data.dart</c>'s <c>Hotel</c>.
/// </summary>
...
{
    /// <summary>
    /// Gets the rating formatted the way Dart prints a double, for example <c>4.0</c>.
    /// </summary>
    public string RatingLabel => Rating.ToString("0.0", System.Globalization.CultureInfo.InvariantCulture);
    ...
    /// </summary>
    public IReadOnlyList<int> Stars { get; } = Enumerable.Range(0, (int)Rating).ToArray();
}
