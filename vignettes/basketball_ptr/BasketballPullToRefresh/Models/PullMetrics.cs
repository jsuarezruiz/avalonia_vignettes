...
public sealed record PullMetrics(double Extent)
{
    ...
    /// <summary>
    /// Gets the area's height, which the pull can stretch to but not past.
    /// </summary>
    public double Height => Extent * BasketballHoop.MaxPull;

    /// <summary>
    /// Gets where the caption sits above the hoop.
    /// </summary>
    public Thickness CaptionMargin => new(0d, Extent * 0.08d, 0d, 0d);

    /// <summary>
    /// Works out the metrics for a screen of the given height.
    /// </summary>
